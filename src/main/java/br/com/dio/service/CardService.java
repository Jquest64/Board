...
public class CardService {
    ...
    public void moveToNextColumn(final Long cardId, final List<BoardColumnInfoDTO> boardColumnsInfo) throws SQLException {
        try {
            ...
            if (dto.blocked()) {
                var message = "O card %s está bloqueado, é necessário desbloquea-lo".formatted(cardId);
    ...
    public void block(final Long id, final String reason, List<BoardColumnInfoDTO> boardColumnsInfo) throws SQLException {
        try {
            ...
            if (currentColumn.kind().equals(FINAL) || currentColumn.kind().equals(CANCEL)) {
                var message = "O card está com uma coluna do tipo %s e não pode ser bloqueado"
